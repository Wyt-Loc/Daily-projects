...
#else
  #define     __I     volatile const          /*!< defines 'read only' permissions      */ //写
#endif
#define     __O     volatile                  /*!< defines 'write only' permissions     */ //只读
#define     __IO    volatile                  /*!< defines 'read / write' permissions   */ //定义读写权限
